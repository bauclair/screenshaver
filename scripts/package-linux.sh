...
mkdir -p "$STAGING_DIR/share/icons/hicolor"
...
# Preserve the conventional hicolor icon hierarchy used by install-linux.sh.
#
# For example:
#
...
#
copy_optional_directory \
    "$PROJECT_ROOT/assets/icons/hicolor" \
    "$STAGING_DIR/share/icons/hicolor"
